...
(function (Saba) {
    ...
    (function (SimpleScenario) {
        ...
        SimpleScenario.validates['n1'] = {
            ...
            'namida': SimpleScenario.isNumeric(0),
        ...
        SimpleScenario.validates['セレナ'] = SimpleScenario.validates['セレナ2'] = SimpleScenario.validates['種親'] = SimpleScenario.validates['リン'] = SimpleScenario.validates['リン2'] = SimpleScenario.validates['ソフィア'] = SimpleScenario.validates['ロナ'] = SimpleScenario.validates['エリス'] = SimpleScenario.validates['ジュリア'] = SimpleScenario.validates['ゴウダ'] = SimpleScenario.validates['エリス2'] = SimpleScenario.validates['ラルゴ'] = SimpleScenario.validates['ランディ'] = SimpleScenario.validates['グルカ'] = SimpleScenario.validates['メル'] = SimpleScenario.validates['ジュリア'] = SimpleScenario.validates['コバック'] = SimpleScenario.validates['シン'] = SimpleScenario.validates['n1'];
        SimpleScenario.validates['セレナの会話'] = SimpleScenario.validates['リンの会話'] = SimpleScenario.validates['メルの会話'] = SimpleScenario.validates['ソフィアの会話'] = SimpleScenario.validates['ロナの会話'] = SimpleScenario.validates['メルの会話'] = SimpleScenario.validates['eroAnime'] = {};
        SimpleScenario.validates[''] = {};
        ...
        SimpleScenario.validates['cos2'] = SimpleScenario.validates['cos3'] = SimpleScenario.validates['cos4'] = SimpleScenario.validates['cos5'] = SimpleScenario.validates['cos6'] = SimpleScenario.validates['cos7'] = SimpleScenario.validates['cos8'] = SimpleScenario.validates['cos9'] = SimpleScenario.validates['cos11'] = SimpleScenario.validates['cos12'] = SimpleScenario.validates['cos13'] = SimpleScenario.validates['cos1'];
        ...
        SimpleScenario.validates['eroUp'] = {};
        ...
        SimpleScenario.validates['route'] = {};
