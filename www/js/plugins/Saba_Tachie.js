...
(function (Saba) {
    ...
    (function (Tachie) {
        ...
        Tachie.offsetX[11] = -30;
        Tachie.offsetX[13] = 50;
        Tachie.offsetX[14] = 0;
        Tachie.offsetX[16] = -90;
        Tachie.offsetX[21] = 120;
        Tachie.offsetY[21] = -30;
        for (var i = 0; i < 99; i++) {
        ...
        var _Game_Interpreter = (function (_super) {
                        ...
                        for (var _i = 0, PICTURES_1 = Tachie.PICTURES; _i < PICTURES_1.length; _i++) {
                            ...
                            if (picture && picture.name() != '') {
                                var c = {
                                    'code': 234,
                                    'indent': this._indent,
                                    'parameters': [pictureId, Tachie.inactiveActorTone, Tachie.toneChangeDuration, false]
                                };
            ...
            _Game_Interpreter.prototype.showTachiePicture = function (actorId, posId, pictureId, x, y, opacity) {
                ...
                var c = {
                    'code': 234,
                    'indent': this._indent,
                    'parameters': [pictureId, [0, 0, 0, 0], Tachie.toneChangeDuration, false]
                };
                this._list.splice(this._index + 1, 0, c);
                if (opacity < 255) {
                    var c = {
            ...
            _Game_Interpreter.prototype.getPosX = function (posId) {
                switch (posId) {
                    ...
                    case Tachie.RIGHT_POS:
                        return Tachie.rightPosX;
                    case Tachie.CENTER_POS:
                        return Tachie.centerPosX;
                    default:
            ...
            _Game_Interpreter.prototype.tachieActorCommnad = function (actor, command, arg2, args) {
                switch (command) {
                    ...
                    case 'hoppe':
                        ...
                        break;
                    case 'namida':
                        actor.setNamidaId(parseInt(arg2));
                        break;
                    case 'outer':
            ...
            _Game_Interpreter.prototype.command232 = function () {
                ...
                if (Input.isPressed(getSkipKey()) && Tachie.PICTURES.indexOf(this._params[0]) > 0) {
                    time = 1;
                }
        ...
        var _Game_Actor = (function (_super) {
            ...
            Object.defineProperty(_Game_Actor.prototype, "namidaId", {
                get: function () {
            ...
            _Game_Actor.prototype.setCacheChanged = function () {
                ...
                this.setDirty();
                $gamePlayer.refresh();
                Saba.actorCashedSprites[this.actorId()] = false;
            };
            ...
            _Game_Actor.prototype.setNamidaId = function (n) {
                if (this._namidaId === n) {
                    return;
                }
                this._namidaId = n;
            ...
            _Game_Actor.prototype.preloadTachie = function () {
                ...
                return;
                if (PIXI.utils.TextureCache[this.bodyFrontFile() + '.png'] || this._loading) { } else {
                    this._loading = true;
            ...
            _Game_Actor.prototype.boteFile = function () {
                var ero = $gameSystem.getEro(this.actorId());
                if (ero && ero.bote > 0) {
                    if (ero.bote >= 2) {
                        return this.baseId + 'bote' + ero.bote;
                    } else {
                        return this.baseId + 'bote';
                    }
                }
                return null;
            };
            ...
            _Game_Actor.prototype.namidaFile = function () {
                if (this.namidaId === 0) {
                    return null;
                }
                return this.baseId + 'namida';
            };
            ...
            _Game_Actor.prototype.acceFile = function (id) {
                ...
                return this.baseId + 'acce' + id;
            };
            _Game_Actor.prototype.acceFileAlpha = function (data) {
        ...
        ImageManager.loadSpriteSheet = function (file, callback) {
            ...
            loader.onComplete.add(function (e, resources) {
                ...
                for (var key in resources) {
                    Saba.spriteSheetCache[key] = resources[key];
                }
        ...
        var _Game_Temp = (function (_super) {
            ...
            _Game_Temp.prototype.getActorBitmapBodyCache = function (picId) {
                this.actorBitmapBodyCache = this.actorBitmapBodyCache || {};
                if (!this.actorBitmapBodyCache[picId]) {
                    if (picId >= 15) {
                        this.actorBitmapBodyCache[picId] = PIXI.RenderTexture.create(1024, 768);
                    } else {
        ...
        var TachieDrawerMixin = function () {
            ...
            this.drawTachieActor = function (actor, parent, x, y, rect, faceId, scale, clearByDraw, naked, alpha) {
                if (x === void 0) {
                    x = 0;
                }
                if (y === void 0) {
                ...
                if (cash == null) {
                    ...
                    this.drawTachieFrontAcce(actor, mainSprite);
                    this.drawTachieOuterFront(actor, mainSprite);

                    if (true) {
                        Graphics._renderer.render(mainSprite, renderTexture);
                        var t = new PIXI.Texture(renderTexture);
                        cash = new PIXI.Sprite(t);
                        Saba.actorCashedSprites[actorId] = true;
                    }
                    mainSprite.destroy({
                        texture: true,
                        children: true
                ...
                if (rect.width > 0 && rect.height > 0) {
                    ...
                    myMask.beginFill();
                    myMask.drawRect(rect.x, rect.y + y, rect.width, rect.height);
                    myMask.endFill();
                ...
                if (this._windowContentsSprite) {
                    ...
                    if (myMask) {
                        this._windowContentsSprite.addChild(myMask);
                    }
                } else if (parent) {
                    if (clearByDraw) {
            ...
            this.drawTachieTextureAtlas = function (file, bitmap, actor, x, y, rect, scale, alpha) {
                ...
                if (bitmap._canvas) {
                    ...
                    var texture = new PIXI.Texture(texture.baseTexture);
            ...
            this.drawTachieOuterBack = function (actor, bitmap) {
                this.drawTachieFile(actor.outerBackFile(), bitmap, actor, undefined, undefined, undefined, undefined, $gameTemp.getOuterAlpha(actor.actorId()));
            };
            this.drawTachieOuterShadow = function (actor, bitmap) {
                this.drawTachieFile(actor.outerShadowFile(), bitmap, actor, undefined, undefined, undefined, undefined, $gameTemp.getOuterAlpha(actor.actorId()));
            };
            this.drawTachieOuterMain = function (actor, bitmap) {
                this.drawTachieFile(actor.outerMainFile(), bitmap, actor, undefined, undefined, undefined, undefined, $gameTemp.getOuterAlpha(actor.actorId()));
            };
            this.drawTachieOuterFront = function (actor, bitmap) {
                this.drawTachieFile(actor.outerFrontFile(), bitmap, actor, undefined, undefined, undefined, undefined, $gameTemp.getOuterAlpha(actor.actorId()));
            };
            this.drawTachieBodyBack = function (actor, bitmap) {
                this.drawTachieFile(actor.bodyBackFile(), bitmap, actor);
                this.drawTachieFile(actor.boteFile(), bitmap, actor);
            };
            ...
            this.drawTachieInnerBottom = function (actor, bitmap) {
                this.drawTachieFile(actor.innerBottomFile(), bitmap, actor, undefined, undefined, undefined, undefined, $gameTemp.getInnerAlpha(actor.actorId()));
            };
            this.drawTachieInnerTop = function (actor, bitmap) {
                this.drawTachieFile(actor.innerTopFile(), bitmap, actor, undefined, undefined, undefined, undefined, $gameTemp.getInnerAlpha(actor.actorId()));
            };
        ...
        var Window_MessageName = (function (_super) {
            ...
            Window_MessageName.prototype.update = function () {
                ...
                if (Tachie.windowMargin[2] > 500) {
                    this.y = Graphics.boxHeight - this.windowHeight - Tachie.windowMargin[0] - Tachie.windowMargin[2];
                }
            };
            Window_MessageName.prototype.draw = function (name) {
                ...
                if (Tachie.windowMargin[2] > 500) {
                    this.width = this.convertEscapeCharacters("1234").length * Tachie.nameWidthPerChar + 40;
                } else {
                    this.width = this.convertEscapeCharacters(name).length * Tachie.nameWidthPerChar + 40;
                }
                this.contents.clear();
        ...
        var Sprite_WindowBalloon = (function (_super) {
            ...
            Sprite_WindowBalloon.prototype.updatePosition = function () {
                if ($gameTemp.tachieActorPos === Tachie.LEFT_POS) {
                    ...
                    this.scale.x = 1;
                    this.x = (Graphics.boxWidth - Tachie.windowMargin[1] - Tachie.windowMargin[3]) / 2 + 190;
                }
                if ($gameSwitches.value(542)) {
                    this.x -= 170;
                }
            };
        ...
        var Window_TachieMessage = (function (_super) {
            ...
            Window_TachieMessage.prototype.refreshTachie = function () {
                for (var _i = 0; _i < 4; _i++) {
                    var battler = $gameActors.actor(_i + 1);
                    battler.setDirty(true);
                }
            };
            ...
            Window_TachieMessage.prototype.updateMessageSkip = function () {
                ...
                if (Input.isPressed(getSkipKey()) && !this._skipDisabled) {
                    if (this._windowHide) {
            ...
            Window_TachieMessage.prototype.updateWindowVisibility = function () {
                if (Input.isTriggered(Tachie.WINDOW_HIDE_KEY)) {
                    this.changeWindowVisibility();
                } else if (this._windowHide && this.isTriggered()) {
...
Game_Temp.prototype.getOuterAlpha = function (actorId) {
    return 1;
};
Game_Temp.prototype.getInnerAlpha = function (actorId) {
    return 1;
};
