...
(function () {
    ...
    Scene_Title.prototype.create = function () {
        ...
        this._commandWindow._windowskin = ImageManager.loadSystem('Window_Battle');
    ...
    Scene_Equip.prototype.create = function () {
        ...
        this._itemWindow._windowskin = _image;
        this._paramWindow._windowskin = _image;

        this._helpWindow._refreshAllParts();
        this._statusWindow._refreshAllParts();
        this._slotWindow._refreshAllParts();
        this._itemWindow._refreshAllParts();
        this._paramWindow._refreshAllParts();
    };

    var _Scene_Status_Create = Scene_Status.prototype.create;
    Scene_Status.prototype.create = function () {
        _Scene_Status_Create.call(this);
        this._statusWindow._windowskin = ImageManager.loadSystem('Window_Battle');
        this._statusWindow._refreshAllParts();
    };
    ...
    Scene_Options.prototype.create = function () {
        ...
        this._optionsWindow._windowskin = ImageManager.loadSystem('Window_Battle');
